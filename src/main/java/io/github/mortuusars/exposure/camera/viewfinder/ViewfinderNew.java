...
public class ViewfinderNew implements IViewfinderNew {
    ...
    public void deactivate(Player player) {
        InteractionHand hand = playersWithActiveViewfinder.remove(player);
        broadcast(player, false, hand);
    }

    @Override
    public boolean isActive(Player player) {
        return playersWithActiveViewfinder.containsKey(player);
    }
